      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className="text-gray-600 text-sm md:text-base">
            Digital solutions to elevate your online presence and drive growth.
          </p>
        </div>
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2">
                {benefits.map((benefit, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-1.5 px-2.5 py-1 bg-gray-50 rounded-md text-xs"
                  >
        ...
        {/* Bottom CTA */}
        <div className="mt-10 bg-blue-50 rounded-xl p-6 text-center border border-blue-100">
          <div className="max-w-2xl mx-auto">
            <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">
              Need a custom solution?
            </h3>
            <p className="text-gray-600 mb-6 text-sm">
              Tailored digital strategies for your business goals and budget.
            </p>
