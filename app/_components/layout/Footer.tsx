      ...
      <div className="container-custom py-8 md:py-10">
              ...
              {[
                ...
                return (
                  <a
                    key={index}
                    href="#"
                    className="w-7 h-7 rounded-md border border-gray-200 flex items-center justify-center text-gray-500 hover:text-blue-600 hover:border-blue-300 transition-colors"
                    aria-label={social.label}
                  >
                    <Icon size={14} />
                  </a>
            ...
            <ul className="space-y-2">
              {["Home", "Services", "Projects", "Contact"].map((item) => (
                <li key={item}>
                  <a
                    href={`#${item.toLowerCase()}`}
                    className="text-sm text-gray-600 hover:text-blue-700 transition-colors flex items-center gap-2 group"
                  >
                    <div className="w-1 h-1 bg-blue-100 rounded-full group-hover:bg-blue-500 transition-colors"></div>
                    {item}
                  </a>
                </li>
              ))}
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={service}>
                  <a
                    href="#services"
                    className="text-sm text-gray-600 hover:text-blue-700 transition-colors flex items-center gap-2"
                  >
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2">
                <div className="w-6 h-6 rounded-md bg-amber-50 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <FiMapPin className="w-3 h-3 text-amber-600" />
                </div>
                <div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex-1 max-w-md">
              ...
              <form onSubmit={handleNewsletter} className="flex gap-2">
                <input
                  ...
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="Your email"
                  className="flex-1 px-3 py-2 text-sm rounded-md border border-gray-300 focus:border-blue-400 focus:ring-1 focus:ring-blue-100 outline-none"
                  required
                />
                <button
                  type="submit"
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center gap-1.5 px-3 py-2 border border-gray-300 rounded-md text-gray-700 hover:border-blue-400 hover:text-blue-700 transition-colors text-sm"
            >
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 text-center">
            <p className="text-gray-500 text-xs">
              &copy; {currentYear} DigitalGrowth. All rights reserved.
              <a href="#" className="mx-1 hover:text-blue-700">
                Privacy
              </a>
              •
              <a href="#" className="mx-1 hover:text-blue-700">
